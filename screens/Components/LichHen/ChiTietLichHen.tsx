  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.detailContainer}>
        ...
        <Text style={styles.detailText}>Trạng thái: {lichHen.trangThai}</Text>
        <Text style={styles.detailText}>Thời gian dự kiến: {new Date(lichHen.thoiGianDuKien).toLocaleString()}</Text>
        <Text style={styles.detailText}>Địa điểm: {lichHen.diaDiem}</Text>
